 ...
 * @author Dimas
 */
public class TambahAgendaDialog extends javax.swing.JDialog {
    /**
    ...
    private void initComponents() {
        ...
        lblTitle.setText("TAMBAH AGENDA BARU");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahAgendaDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahAgendaDialog dialog = new TambahAgendaDialog(new javax.swing.JFrame(), true);
